...
{
    public class TreeListViewLayoutManager
    {
        ...
        public static readonly DependencyProperty EnabledProperty = DependencyProperty.RegisterAttached(
            "Enabled",
            typeof(bool),
            typeof(TreeListViewLayoutManager),
            new FrameworkPropertyMetadata(new PropertyChangedCallback(OnLayoutManagerEnabledChanged)));

        // ----------------------------------------------------------------------
        public TreeListViewLayoutManager(TreeListView listView)
        {
            if (listView == null)
            {
                throw new ArgumentNullException("TreelistView");
            }
        ...
        private static void OnLayoutManagerEnabledChanged(DependencyObject dependencyObject, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (listView != null)
            {
                ...
                if (enabled)
                {
                    new TreeListViewLayoutManager(listView);
                }
            }
