...
namespace GenLibrary.Animation
{
    //<ColumnDefinition Width = "350" x:Name="Part_columnHistory"    
                       
    //                   <!--掩藏历史列动画-->
    //                    <Storyboard x:Key="hideHistoryList" Storyboard.TargetName="Part_columnHistory" Storyboard.TargetProperty="Width">
    //                        <ani:GridLengthAnimation To = "0" Duration="0:0:0.3" >
    //                        </ani:GridLengthAnimation>
    //                    </Storyboard>
    //                    <!--显示历史列动画-->
    //                    <Storyboard x:Key="showHistoryList" Storyboard.TargetName="Part_columnHistory" Storyboard.TargetProperty="Width">
    //                        <ani:GridLengthAnimation To = "350" Duration="0:0:0.3">
    //                        </ani:GridLengthAnimation>
    //                    </Storyboard>
    public class GridLengthAnimation : AnimationTimeline
    {
        ...
        public override object GetCurrentValue(object defaultOriginValue, object defaultDestinationValue, AnimationClock animationClock)
        {
            ...
            if (From == null || From == GridLength.Auto)
                fromValue = ((GridLength)defaultDestinationValue).Value;
            else
                fromValue = ((GridLength)this.GetValue(GridLengthAnimation.FromProperty)).Value;
            if (To == null || To == GridLength.Auto)
                toValue = ((GridLength)defaultOriginValue).Value;
            else
                toValue = ((GridLength)GetValue(GridLengthAnimation.ToProperty)).Value;
